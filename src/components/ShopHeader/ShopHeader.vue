<template>
  <div class="shop-header">
    ...
    <nav class="shop-nav" :style="{backgroundImage: `url(${info.bgImg})`}">
      <a class="back">
        <i @click="$router.push('/home')" class="iconfont icon-arrow_left"></i>
      </a>
    </nav>
    ...
    <transition name="fade">
      <!-- 品牌详情的Modal框   -->
      <div class="shop-brief-modal" v-show="isShowShop">
    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="isShowSupports" >
        <div class="activity-sheet-content">
          ...
          <ul class="list">
            <li class="activity-item" v-for="(item, index) in info.supports" :class="supportClasses[item.type]" :key="index">
            <span class="content-tag">
